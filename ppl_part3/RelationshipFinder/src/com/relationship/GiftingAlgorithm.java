...
public abstract class GiftingAlgorithm implements Algorithm {
     ...
     * @throws GiftStoreEmptyException when there is no gift available for gifting 
     * @return the list of gifts
     */
    public abstract ArrayList<Gift> makeGiftBasket() throws GiftStoreEmptyException;
