...
public class ScanIpBestK {
     ...
     * @return list of boys
     */
    public BestKvalued<Boy> getBoyList(int k) {
        String name;
        int attractiveness;
        double girlfriendBudget;
        int intelligenceLevel;
        String type;
        boyList = new BestKvalued<Boy>(k);
        try {
     ...
     */
    public BestKvalued<Girl> getGirlList(int k) {
        String name;
        int attractiveness;
        double maintenanceBudget;
        int intelligenceLevel;
        String type;
        girlList = new BestKvalued<Girl>(k);
        try {
     ...
     */
    public BestKvalued<Gift> getGiftList(int k) {
        String name;
        int rating;
        String difficulty;
        float price;
        ...
        String utilityClass;
        String type;
        giftList = new BestKvalued<Gift>(k);
        try {
