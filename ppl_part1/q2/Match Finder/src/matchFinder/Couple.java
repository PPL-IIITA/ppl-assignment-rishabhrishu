...
public class Couple {
     ...
     * @param giftStore Gift Store, from which guy can buy gifts from his
     * girl.(Formally, a list of all the gifts)
     *
     */
     ...
     * More formally, this method greedily selects the set of 'best' gifts a boy
     * can give to his girlfriend
     */
    ...
    public void logger() {
        ...
        try {
            FileWriter fileWriter = new FileWriter(file, true);
            Timestamp ts = new Timestamp(System.currentTimeMillis());
            fileWriter.write(ts + ": Couple Created :\n" + this.toString() + "\n");
            fileWriter.flush();
        } catch (Exception ex) {
